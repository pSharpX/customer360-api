...
/****** Object:  StoredProcedure [dbo].[sgsnet_sps_venta_por_cliente]    Script Date: 19/01/2018 17:20:37 ******/
DROP PROCEDURE [dbo].[sgsnet_sps_venta_por_cliente]
GO
...
CREATE PROCEDURE [dbo].[sgsnet_sps_venta_por_cliente]
/*****************************************************************************
Objetivo		: Listado de ventas de un determinado Cliente.
Autor			: Hundred(Christian Rivera).
Fecha Creación	: (19/01/2018 18:35)
Historial		: El procedimiento almacenado lista las ventas de un determinado Cliente.
****************************************************************************
@001 HUNDRED(Christian Rivera) 19/01/2018 Creacion
****************************************************************************/
(
...
------------------------------------------------------------------------------
 ...
 where fl_inactivo_dw='0' and fl_inactivo='0'
   and nu_documento_cliente = @numeroDocumento
 
  END
GO

--Testing [sgsnet_sps_venta_por_cliente]
--exec [sgsnet_sps_venta_por_cliente] '20491555140'