...
{
    public class ProcesoEjecucionDetalleRepository:RepositoryBase<ProcesoEjecucionDetalle>
    {
        public ProcesoEjecucionDetalleRepository(Cliente360DbContext cliente360DbContext)
