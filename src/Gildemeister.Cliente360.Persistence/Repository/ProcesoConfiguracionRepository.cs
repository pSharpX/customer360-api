...
{
    public class ProcesoConfiguracionRepository:RepositoryBase<ProcesoConfiguracion>
    {
        public ProcesoConfiguracionRepository(Cliente360DbContext cliente360DbContext)
