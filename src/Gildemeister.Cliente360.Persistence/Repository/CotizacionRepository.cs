...
namespace Gildemeister.Cliente360.Persistence.Repository
{
    public class CotizacionRepository : RepositoryBase<Cotizacion>, ICotizacionRepository
    {
        ...
        public Task<IEnumerable<Cotizacion>> BuscarPorClienteAsync(string clienteId)
        {
            throw new NotImplementedException();
        ...
        public Task<Cotizacion> BuscarPorCodigoAsync(string clienteId, string cotizacionId)
        {
            throw new NotImplementedException();
        }
